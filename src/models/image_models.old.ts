 ...
 */
export interface ImageFileDetailsInterface {
  filename: string;
  identifier: string;
...
export class ImageFileDetails {
  ...
  toJSON(): ImageFileDetailsInterface {
    return {
  ...
  static isFileDetailsInterface(
    input: unknown,
  ): input is ImageFileDetailsInterface {
    return (
      isRecord(input) &&
...
export interface NewImageDetailsInterface {
  imageId: string;
  files: ImageFileDetailsInterface[];
